...
export const SILHOUETTES: SilhouetteMeta[] = [
  { id: "round", name: "Round", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "pill", name: "Flat Pill", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "chamfer", name: "Shallow Chamfer", source: "custom", license: "original", renderer: "procedural",
    capScale: 0.2, content: { top: 0.14, right: 0.24, bottom: 0.14, left: 0.24 }, minWidth: 80, minHeight: 40,
    supports: BTN, character: "Small 45° corner cuts." },
  { id: "sharp", name: "Sharp", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "hex", name: "Hex", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "trapezoid", name: "Trapezoid", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "notch", name: "Notch", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "chunky", name: "Heavy Rounded Capsule", source: "custom (Crewmate study)", license: "original", renderer: "procedural",
  ...
  { id: "cutline", name: "Sport Cutline", source: "custom (broadcast study)", license: "original", renderer: "procedural",
  ...
  { id: "polybar", name: "Racing Polybar", source: "custom (automotive study)", license: "original", renderer: "procedural",
  ...
  { id: "explorer", name: "Cosmic Explorer", source: "custom (sci-fi study)", license: "original", renderer: "procedural",
  ...
  { id: "kart", name: "Mechanical End-Cap Rail", source: "custom (kart study)", license: "original", renderer: "procedural",
    capScale: 0.62, content: { top: 0.2, right: 0.66, bottom: 0.2, left: 0.66 }, minWidth: 150, minHeight: 48,
    supports: BTN, character: "Caps taller than the rail — stepped waist." },
  { id: "mazepill", name: "Retro Maze Pill", source: "custom (arcade study)", license: "original", renderer: "procedural",
  ...
  { id: "fighthud", name: "Fighting HUD", source: "custom (versus study)", license: "original", renderer: "procedural",
  ...
  { id: "crest", name: "Blade Crest", source: "custom (ceremonial study)", license: "original", renderer: "procedural",
  ...
  { id: "blade", name: "Persian Blade", source: "custom (ornamental study)", license: "original", renderer: "procedural",
  ...
  { id: "tavern", name: "Concave Fantasy Plaque", source: "custom (tavern study)", license: "original", renderer: "procedural",
  ...
  { id: "handdrawn", name: "Hand-Drawn Frame", source: "custom + Rough.js ink (seeded)", license: "original / MIT", renderer: "procedural",
  ...
  { id: "deepchamfer", name: "Deep Chamfer", source: "custom", license: "original", renderer: "procedural",
    capScale: 0.44, content: { top: 0.18, right: 0.46, bottom: 0.18, left: 0.46 }, minWidth: 120, minHeight: 44,
    supports: BTN, character: "Cuts near half the height — elongated octagon." },
  { id: "banner", name: "Pointed Banner", source: "custom (ribbon study)", license: "original", renderer: "procedural",
  ...
  { id: "shield", name: "Shield Plaque", source: "custom (heraldic study)", license: "original", renderer: "procedural",
  ...
  { id: "pixelstep", name: "Pixel-Stepped Frame", source: "custom (8-bit study)", license: "original", renderer: "procedural",
