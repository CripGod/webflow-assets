...
export const SILHOUETTES: SilhouetteMeta[] = [
  ...
  { id: "doboMarquee", name: "Marquee Plaque", category: "Banners & Labels", source: "custom study (after an itch.io header)", license: "original", renderer: "procedural",
    capScale: 0.28, content: { top: 0.12, right: 0.34, bottom: 0.36, left: 0.34 }, minWidth: 150, minHeight: 52,
    supports: ["button", "badge", "tab"], character: "Tapered plate over side drapes with rounded feet — measured proportions, drawn as an original study." },
  { id: "doboRibbon", name: "Bow Ribbon", category: "Banners & Labels", source: "custom study (after an itch.io ribbon)", license: "original", renderer: "procedural",
    capScale: 0.26, content: { top: 0.12, right: 0.32, bottom: 0.38, left: 0.32 }, minWidth: 150, minHeight: 52,
    supports: ["button", "badge", "tab"], character: "Tapered plate with swallowtail side tails — measured proportions, drawn as an original study." },
