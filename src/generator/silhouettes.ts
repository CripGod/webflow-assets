...
export const SILHOUETTES: SilhouetteMeta[] = [
  ...
  { id: "chamfer", name: "Shallow Chamfer", category: "Buttons", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "kart", name: "Mechanical End-Cap Rail", category: "Rails & HUD", source: "custom (kart study)", license: "original", renderer: "procedural",
  ...
  { id: "deepchamfer", name: "Deep Chamfer", category: "Buttons", source: "custom", license: "original", renderer: "procedural",
  ...
  { id: "kenneyRect", name: "Kenney Rectangle", category: "Buttons", source: "Kenney UI Pack 2.0 — button_rectangle", license: "CC0", renderer: "procedural",
  ...
  { id: "kenneyTag", name: "Kenney Tag", category: "Banners & Labels", source: "Kenney UI Pack 2.0 — slide_hangle (rotated)", license: "CC0", renderer: "procedural",
    capScale: 0.31, content: { top: 0.14, right: 0.36, bottom: 0.14, left: 0.18 }, minWidth: 96, minHeight: 40,
    supports: ["button", "chip", "badge", "tab"], character: "Pointer tag — 45° shoulders and tip rounding measured from the slider handle." },
  { id: "doboMarquee", name: "Marquee Plaque", category: "Banners & Labels", source: "Vector UI Pack (dobo_ui) — headerAsim", license: "itch.io pack — verify terms", renderer: "procedural",
    capScale: 0.28, content: { top: 0.12, right: 0.34, bottom: 0.36, left: 0.34 }, minWidth: 150, minHeight: 52,
    supports: ["button", "badge", "tab"], character: "Tapered plate over side drapes with rounded feet — measured from headerAsim." },
  { id: "doboRibbon", name: "Bow Ribbon", category: "Banners & Labels", source: "Vector UI Pack (dobo_ui) — headerBow", license: "itch.io pack — verify terms", renderer: "procedural",
    capScale: 0.26, content: { top: 0.12, right: 0.32, bottom: 0.38, left: 0.32 }, minWidth: 150, minHeight: 52,
    supports: ["button", "badge", "tab"], character: "Tapered plate with swallowtail side tails — measured from headerBow." },
  { id: "doboBracket", name: "Bracket Label", category: "Banners & Labels", source: "Vector UI Pack (dobo_ui) — labelAdvanced", license: "itch.io pack — verify terms", renderer: "procedural",
    capScale: 0.36, content: { top: 0.14, right: 0.42, bottom: 0.14, left: 0.42 }, minWidth: 120, minHeight: 44,
    supports: ["button", "chip", "badge", "tab", "progress"], character: "Bar with half-round side lobes and meeting notches — measured from labelAdvanced." },
];
